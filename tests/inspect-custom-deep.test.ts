...
describe("Bun.inspect.custom deep behaviors", () => {
  describe("depth propagation", () => {
    test("custom inspect receives depth=8 by default", () => {
      class P {
        received = -1;
    ...
    test("nested custom inspect gets depth-1", () => {
      class Outer {
        [Bun.inspect.custom](depth: number) {
          return {
            outerDepth: depth,
    ...
    test("depth decreases recursively through nested objects", () => {
      class Recursive {
        level: number;
  ...
  describe("options passed to custom inspect", () => {
    test("receives stylize, depth, and colors keys", () => {
      class P {
        keys = "";
    ...
    test("Node.js compat options (showHidden, compact) silently ignored", () => {
  ...
  describe("return value handling", () => {
    test("returning string — used as-is", () => {
      class S {
        [Bun.inspect.custom]() {
    ...
    test("returning number — converted to string", () => {
      class N {
        [Bun.inspect.custom]() {
          return 42;
        }
    ...
    test("returning null — shows 'null'", () => {
      class Null {
        [Bun.inspect.custom]() {
          return null;
        }
    ...
    test("returning undefined — shows 'undefined'", () => {
      class Undef {
        [Bun.inspect.custom]() {
          return undefined;
        }
    ...
    test("returning object — recursively inspected", () => {
      class O {
        [Bun.inspect.custom]() {
          return { nested: "value" };
        }
    ...
    test("returning array — inspected as array", () => {
      class A {
        [Bun.inspect.custom]() {
          return [1, 2, 3];
        }
  ...
  describe("ANSI in custom inspect output", () => {
    test("ANSI codes pass through with colors: false", () => {
      class Ansi {
        [Bun.inspect.custom]() {
    ...
    test("ANSI codes pass through with colors: true", () => {
      class Ansi {
        [Bun.inspect.custom]() {
          return "\x1b[31mred\x1b[0m";
        }
  ...
  describe("self-referential custom inspect", () => {
    test("throws Maximum call stack size exceeded", () => {
      class Self {
        [Bun.inspect.custom]() {
          return new Self();
        }
  ...
  describe("custom inspect wins over Symbol.toStringTag", () => {
    test("custom inspect takes priority", () => {
      class Tagged {
  ...
  describe("Node.js compatibility", () => {
    test("Bun.inspect.custom === util.inspect.custom", async () => {
