...
describe("known limitations", () => {
  ...
  test("extractDominantColor returns the real dominant color (not the stub)", async () => {
    ...
    const redPng = new Uint8Array([
      ...
      137, 0, 0, 0, 13, 73, 68, 65, 84, 120, 218, 99, 252, 255, 159, 161, 30, 0, 7, 130, 2, 127, 61, 200, 72, 239, 0, 0,
